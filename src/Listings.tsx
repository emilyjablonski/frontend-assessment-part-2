    ...
    <div className={"content"}>
      <div className={"container"}>
        <div className={"filters"}>
          <TextInput
            ...
            onChange={(e) => {
              ...
              if (!value) {
                ...
                setSearchData(listingData.filter((item) => item.name.includes(value) || item.tableHeader?.includes(value) || item.tableSubheader?.includes(value)))
              }
            }}
          />
          <TextInput
          ...
          />
          <Pagination numSteps={limit ? Math.ceil(searchData.length / limit) : 1} selected={selected} setSelected={setSelected} />
        </div>
