        ...
        <tbody>
          {props.unitRows.map((row, index) => (
            <tr key={index}>
              ...
              <td>{row.minIncomeMinimum.toLocaleString() === row.minIncomeMaximum.toLocaleString() ? `${row.minIncomeMinimum.toLocaleString()} per month` : `$${row.minIncomeMinimum.toLocaleString()} - $${row.minIncomeMaximum.toLocaleString()} per month`}</td>
              <td>{getRent(row)}</td>
            </tr>
          ))}
        </tbody>
